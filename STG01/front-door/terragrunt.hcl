...
dependency "function_app" {
  ...
  mock_outputs = {
    default_hostname = "func-radshow-stg01-scus.azurewebsites.net"
  }
...
dependency "function_app_secondary" {
  ...
  mock_outputs = {
    default_hostname = "func-radshow-stg01-ncus.azurewebsites.net"
  }
  mock_outputs_allowed_terraform_commands = ["validate", "plan"]
}
...
dependency "storage" {
  ...
  mock_outputs = {
    primary_web_host = "stradshowstg01scus.z21.web.core.windows.net"
  }
  mock_outputs_allowed_terraform_commands = ["validate", "plan"]
}
...
dependency "storage_secondary" {
  ...
  mock_outputs = {
    primary_web_host = "stradshowstg01ncus.z21.web.core.windows.net"
  }
  mock_outputs_allowed_terraform_commands = ["validate", "plan"]
}
