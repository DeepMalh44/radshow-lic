# PRD01 / pe-funcapp-secondary
# Private endpoint for secondary Function App
include "root" {
...
inputs = {
  name                           = "pe-func-${local.env_vars.locals.name_prefix}-${local.env_vars.locals.secondary_short}"
  ...
  private_connection_resource_id = dependency.function_app_secondary.outputs.function_app_id
